...
func elideStage(root *evaluationStage) *evaluationStage {
	...
	var leftValue, rightValue, leftStageValue, rightStageValue, result interface{}
	var err error
	...
	leftValue, leftStageValue, rightStageValue, err = root.leftStage.operator(nil, nil, nil, nil, nil)
	if err != nil {
		return root
	}

	rightValue, leftStageValue, rightStageValue, err = root.rightStage.operator(nil, nil, nil, nil, nil)
	if err != nil {
		return root
	}
	...
	result, leftStageValue, rightStageValue, err = root.operator(leftValue, rightValue, leftStageValue, rightStageValue, nil)
	if err != nil {
		return root
	}
